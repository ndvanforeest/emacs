...
I set the variable =use-package-verbose= to =t= to see which packages get loaded during init and how long it takes to load them.
...
todo I tried the below, but then suddenly the left margin is much larger (at least when I open an org file). As I don't want that, I stick to what I had.
...
* TODO Dired, zet in een use package
...
* Parentheses
I don't think I want delimiters with different colors, hence no rainbow delimiters for me.
